...
<head>
    ...
    <link rel="stylesheet" href="..\assets\css\adminpagecss.css">
    ...
    <font face="Arial Black">
        ...
        <div class="btn"style="position:absolute; right:130px; top:20px;"><a href="../index.html">logout</a></div>
    </font>
</head>
...
public function patients_list()
{
    $html='<li>
        ...
        <ul>
            ...
            <li><a href="../patient/view/Addpatient.html">register new patients</a></li>
            <li><a href="#">search for patient</a></li>
            <li><a href="#">list all patients</a></li>
            <li><a href="../patient/Controller/view_patient_with_details.php">patient view with appointment details</a></li>
        </ul>
    </li>';
...
public function User_list()
{
        ...
        <ul>
            <li><a href="Admin_pages/view/Adduser.html">Add user</a></li>
            <li><a href="Admin_pages/control/view_users.php">List user</a></li>
            <li><a href="../Doctors details/Control/view_doctors.php">doctor list</a></li>
            <li><a href="Admin_pages/view/Appoint_View.php">search appointments</a></li>
...
public function laboratory_view()
{
           $html='<li>
                ...
                <ul>
                    <li><a href="Decorative_Analysis/controller/Analysis.php">Add new test</a></li>
                    <li><a href="Decorative_Analysis/controller/View_Analysis.php">List all tests</a></li>
                </ul>
            </li>
        </ul>
        </nav>';
